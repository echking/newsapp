                    ...
                    if (password_edit.length() == 0) {
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                //10.66.36.157 47.242.191.232
                                String urlAddress = "http://10.66.36.157:8080/login.do?username=" + username_edit.getText().toString() + "&password=" + password_edit.getText().toString();
                                try {
                                    ...
                                    if (code == 200) {
                                        ...
                                        if (result_code == 200) {
                                            ...
                                            if (cbPd.isChecked()) {
                                                ...
                                                boolean flag = save_userMes(LoginActivity.this, username_str, password_str);
                                            }else{
                                                boolean flag =remove_userMes(LoginActivity.this);
                                                }
                                            ...
                                            SharedPreUtil.setNickNameData(LoginActivity.this,SharedPreUtil.NICKNAME_DATA,u.getNickname());
...
//                                            String nickname_login=u.getNickname();
//                                            String username_login=u.getUsername();
                                            Intent intent = new Intent(LoginActivity.this, MainActivity.class);
//                                            newInstance(u.getUsername());
                                            intent.putExtra("nickname_extra",u.getNickname());
    ...
    public static Bundle newInstance(String username_login) {
        MineFragment fragment = new MineFragment();
        Bundle bundle = new Bundle();
        bundle.putString("username_bundle",username_login);
