    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.layout_main: {
                ...
                img_main.setImageResource(R.drawable.home_on);
                img_seting.setImageResource(R.drawable.settings);
                img_mine.setImageResource(R.drawable.me);
            ...
            case R.id.layout_setting: {
                ...
                img_main.setImageResource(R.drawable.home);
                img_seting.setImageResource(R.drawable.settings_on);
                img_mine.setImageResource(R.drawable.me);
            }
            break;
...
//                startActivity(intent);
                ...
                img_main.setImageResource(R.drawable.home);
                img_seting.setImageResource(R.drawable.settings);
                img_mine.setImageResource(R.drawable.me_on);
            }
            break;
            default:
                break;
